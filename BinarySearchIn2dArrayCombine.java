...
class BinarySearchIn2dArrayCombine{
    public static void main(String[] args) {
        ...
        target = 9;
        System.out.println(Arrays.toString(CompleteBinarySearch(arr, target)));
    }
    ...
    public static int[] CompleteBinarySearch(int[][] arr, int target) {
        int rows = arr.length;
